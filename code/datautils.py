...
def load_dataset(name):
    ...
    if name == 'mnist':
        return prepare_dataset(
            '/root/shapley_school/mlp-nas/code/DATASETS/mnist.csv',
        ...
        return prepare_dataset(
            'DATASETS/wine.csv',
             ...
             label_type="string")
    elif name == 'schoolbullying':
        return prepare_dataset(
            '/root/shapley_school/mlp-nas/code/DATASETS/schoolbullying/inner_schoolbullying.csv',
