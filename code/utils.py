...
########################################################
def clean_log():
    filelist = os.listdir('/root/shapley_school/mlp-nas/code/LOGS')

    for file in filelist:
        if os.path.isfile('/root/shapley_school/mlp-nas/code/LOGS/{}'.format(file)):
            os.remove('/root/shapley_school/mlp-nas/code/LOGS/{}'.format(file))
...
def get_latest_event_id():
    ...
    """
    all_subdirs = ['/root/shapley_school/mlp-nas/code/LOGS/' + d for d in os.listdir('/root/shapley_school/mlp-nas/code/LOGS')
                               if os.path.isdir('/root/shapley_school/mlp-nas/code/LOGS/' + d)]

    latest_subdir = max(all_subdirs, key=os.path.getmtime)
    return int(latest_subdir.replace('/root/shapley_school/mlp-nas/code/LOGS/event', ''))
...
def load_nas_data():
    ...
    data_file = '/root/shapley_school/mlp-nas/code/LOGS/event{}/nas_data.pkl'.format(event)
